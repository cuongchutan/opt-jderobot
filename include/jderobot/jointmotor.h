...
#ifndef __jderobot_jointmotor_h__
#define __jderobot_jointmotor_h__
...
struct MotorState
{
     ...
     * @return The data members in a tuple.
     */
    std::tuple<const float&, const float&, const float&, const ::std::string&, const int&, const int&, const bool&> ice_tuple() const
    {
        return std::tie(pos, vel, power, timeStamp, p, v, isMoving);
    }
};
...
struct MotorParams
{
     ...
     * @return The data members in a tuple.
     */
    std::tuple<const ::std::string&, const ::Ice::Byte&, const float&, const float&, const float&, const float&, const bool&> ice_tuple() const
    {
        return std::tie(name, busId, minPos, maxPos, maxVelocity, zeroPos, invertedSign);
    }
};
...
struct StreamReader<::RoboCompJointMotor::MotorState, S>
{
    ...
    {
        istr->readAll(v.pos, v.vel, v.power, v.timeStamp, v.p, v.v, v.isMoving);
    }
};
...
struct StreamReader<::RoboCompJointMotor::MotorParams, S>
{
    ...
    {
        istr->readAll(v.name, v.busId, v.minPos, v.maxPos, v.maxVelocity, v.zeroPos, v.invertedSign);
    }
};
