...
if 'CameraDescription' not in _M_jderobot.__dict__:
    ...
    class CameraDescription(Ice.Value):
        """
    ...
    _M_jderobot._t_CameraDescription = IcePy.defineValue('::jderobot::CameraDescription', CameraDescription, -1, (), False, False, None, (
...
_M_jderobot._t_Camera = IcePy.defineValue('::jderobot::Camera', Ice.Value, -1, (), False, True, None, ())

if 'CameraPrx' not in _M_jderobot.__dict__:
    _M_jderobot.CameraPrx = Ice.createTempClass()
    class CameraPrx(_M_jderobot.ImageProviderPrx):

        def getCameraDescription(self, context=None):
            return _M_jderobot.Camera._op_getCameraDescription.invoke(self, ((), context))

        def getCameraDescriptionAsync(self, context=None):
            return _M_jderobot.Camera._op_getCameraDescription.invokeAsync(self, ((), context))

        def begin_getCameraDescription(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.Camera._op_getCameraDescription.begin(self, ((), _response, _ex, _sent, context))

        def end_getCameraDescription(self, _r):
            return _M_jderobot.Camera._op_getCameraDescription.end(self, _r)

        def setCameraDescription(self, description, context=None):
            return _M_jderobot.Camera._op_setCameraDescription.invoke(self, ((description, ), context))

        def setCameraDescriptionAsync(self, description, context=None):
            return _M_jderobot.Camera._op_setCameraDescription.invokeAsync(self, ((description, ), context))

        def begin_setCameraDescription(self, description, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.Camera._op_setCameraDescription.begin(self, ((description, ), _response, _ex, _sent, context))

        def end_setCameraDescription(self, _r):
            return _M_jderobot.Camera._op_setCameraDescription.end(self, _r)

        def startCameraStreaming(self, context=None):
            return _M_jderobot.Camera._op_startCameraStreaming.invoke(self, ((), context))

        def startCameraStreamingAsync(self, context=None):
            return _M_jderobot.Camera._op_startCameraStreaming.invokeAsync(self, ((), context))

        def begin_startCameraStreaming(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.Camera._op_startCameraStreaming.begin(self, ((), _response, _ex, _sent, context))

        def end_startCameraStreaming(self, _r):
            return _M_jderobot.Camera._op_startCameraStreaming.end(self, _r)

        def stopCameraStreaming(self, context=None):
            return _M_jderobot.Camera._op_stopCameraStreaming.invoke(self, ((), context))

        def stopCameraStreamingAsync(self, context=None):
            return _M_jderobot.Camera._op_stopCameraStreaming.invokeAsync(self, ((), context))

        def begin_stopCameraStreaming(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.Camera._op_stopCameraStreaming.begin(self, ((), _response, _ex, _sent, context))

        def end_stopCameraStreaming(self, _r):
            return _M_jderobot.Camera._op_stopCameraStreaming.end(self, _r)

        def reset(self, context=None):
            return _M_jderobot.Camera._op_reset.invoke(self, ((), context))

        def resetAsync(self, context=None):
            return _M_jderobot.Camera._op_reset.invokeAsync(self, ((), context))

        def begin_reset(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.Camera._op_reset.begin(self, ((), _response, _ex, _sent, context))
        ...
        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.CameraPrx.ice_checkedCast(proxy, '::jderobot::Camera', facetOrContext, context)
    ...
    class Camera(_M_jderobot.ImageProvider):
        ...
        def getCameraDescription(self, current=None):
            raise NotImplementedError("servant method 'getCameraDescription' not implemented")

        def setCameraDescription(self, description, current=None):
            raise NotImplementedError("servant method 'setCameraDescription' not implemented")

        def startCameraStreaming(self, current=None):
            raise NotImplementedError("servant method 'startCameraStreaming' not implemented")

        def stopCameraStreaming(self, current=None):
            raise NotImplementedError("servant method 'stopCameraStreaming' not implemented")

        def reset(self, current=None):
            raise NotImplementedError("servant method 'reset' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_CameraDisp)

        __repr__ = __str__

    _M_jderobot._t_CameraDisp = IcePy.defineClass('::jderobot::Camera', Camera, (), None, (_M_jderobot._t_ImageProviderDisp,))
    Camera._ice_type = _M_jderobot._t_CameraDisp
