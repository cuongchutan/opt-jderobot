...
if 'pointCloudData' not in _M_jderobot.__dict__:
    ...
    class pointCloudData(Ice.Value):
    ...
    _M_jderobot._t_pointCloudData = IcePy.defineValue('::jderobot::pointCloudData', pointCloudData, -1, (), False, False, None, (('p', (), _M_jderobot._t_RGBPointsPCL, False, 0),))
    pointCloudData._ice_type = _M_jderobot._t_pointCloudData

    _M_jderobot.pointCloudData = pointCloudData
    del pointCloudData

_M_jderobot._t_pointCloud = IcePy.defineValue('::jderobot::pointCloud', Ice.Value, -1, (), False, True, None, ())

if 'pointCloudPrx' not in _M_jderobot.__dict__:
    _M_jderobot.pointCloudPrx = Ice.createTempClass()
    class pointCloudPrx(Ice.ObjectPrx):

        def getCloudData(self, context=None):
            return _M_jderobot.pointCloud._op_getCloudData.invoke(self, ((), context))

        def getCloudDataAsync(self, context=None):
            return _M_jderobot.pointCloud._op_getCloudData.invokeAsync(self, ((), context))

        def begin_getCloudData(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.pointCloud._op_getCloudData.begin(self, ((), _response, _ex, _sent, context))
        ...
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.pointCloudPrx.ice_checkedCast(proxy, '::jderobot::pointCloud', facetOrContext, context)
    ...
    class pointCloud(Ice.Object):
        ...
        def getCloudData(self, current=None):
            raise NotImplementedError("servant method 'getCloudData' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_pointCloudDisp)

        __repr__ = __str__

    _M_jderobot._t_pointCloudDisp = IcePy.defineClass('::jderobot::pointCloud', pointCloud, (), None, ())
    pointCloud._ice_type = _M_jderobot._t_pointCloudDisp
...
_M_jderobot._t_remoteCloud = IcePy.defineValue('::jderobot::remoteCloud', Ice.Value, -1, (), False, True, None, ())

if 'remoteCloudPrx' not in _M_jderobot.__dict__:
    ...
    class remoteCloudPrx(_M_jderobot.pointCloudPrx):
        ...
        def initConfiguration(self, context=None):
            return _M_jderobot.remoteCloud._op_initConfiguration.invoke(self, ((), context))

        def initConfigurationAsync(self, context=None):
            return _M_jderobot.remoteCloud._op_initConfiguration.invokeAsync(self, ((), context))

        def begin_initConfiguration(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.remoteCloud._op_initConfiguration.begin(self, ((), _response, _ex, _sent, context))
        ...
        def read(self, id, context=None):
            return _M_jderobot.remoteCloud._op_read.invoke(self, ((id, ), context))

        def readAsync(self, id, context=None):
            return _M_jderobot.remoteCloud._op_read.invokeAsync(self, ((id, ), context))

        def begin_read(self, id, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.remoteCloud._op_read.begin(self, ((id, ), _response, _ex, _sent, context))

        def end_read(self, _r):
            return _M_jderobot.remoteCloud._op_read.end(self, _r)

        def write(self, data, id, context=None):
            return _M_jderobot.remoteCloud._op_write.invoke(self, ((data, id), context))

        def writeAsync(self, data, id, context=None):
            return _M_jderobot.remoteCloud._op_write.invokeAsync(self, ((data, id), context))

        def begin_write(self, data, id, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.remoteCloud._op_write.begin(self, ((data, id), _response, _ex, _sent, context))

        def end_write(self, _r):
            return _M_jderobot.remoteCloud._op_write.end(self, _r)

        def setConfiguration(self, id, context=None):
            return _M_jderobot.remoteCloud._op_setConfiguration.invoke(self, ((id, ), context))

        def setConfigurationAsync(self, id, context=None):
            return _M_jderobot.remoteCloud._op_setConfiguration.invokeAsync(self, ((id, ), context))

        def begin_setConfiguration(self, id, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.remoteCloud._op_setConfiguration.begin(self, ((id, ), _response, _ex, _sent, context))
        ...
        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.remoteCloudPrx.ice_checkedCast(proxy, '::jderobot::remoteCloud', facetOrContext, context)
    ...
    class remoteCloud(_M_jderobot.pointCloud):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_remoteCloudDisp)

        __repr__ = __str__

    _M_jderobot._t_remoteCloudDisp = IcePy.defineClass('::jderobot::remoteCloud', remoteCloud, (), None, (_M_jderobot._t_pointCloudDisp,))
    remoteCloud._ice_type = _M_jderobot._t_remoteCloudDisp
