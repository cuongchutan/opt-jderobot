...
if 'EncodersData' not in _M_jderobot.__dict__:
    ...
    _M_jderobot._t_EncodersData = IcePy.defineValue('::jderobot::EncodersData', EncodersData, -1, (), False, False, None, (
...
_M_jderobot._t_Encoders = IcePy.defineValue('::jderobot::Encoders', Ice.Value, -1, (), False, True, None, ())

if 'EncodersPrx' not in _M_jderobot.__dict__:
    _M_jderobot.EncodersPrx = Ice.createTempClass()
    class EncodersPrx(Ice.ObjectPrx):

        def getEncodersData(self, context=None):
            return _M_jderobot.Encoders._op_getEncodersData.invoke(self, ((), context))

        def getEncodersDataAsync(self, context=None):
            return _M_jderobot.Encoders._op_getEncodersData.invokeAsync(self, ((), context))

        def begin_getEncodersData(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.Encoders._op_getEncodersData.begin(self, ((), _response, _ex, _sent, context))
        ...
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.EncodersPrx.ice_checkedCast(proxy, '::jderobot::Encoders', facetOrContext, context)
    ...
    class Encoders(Ice.Object):
        ...
        def getEncodersData(self, current=None):
            raise NotImplementedError("servant method 'getEncodersData' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_EncodersDisp)

        __repr__ = __str__

    _M_jderobot._t_EncodersDisp = IcePy.defineClass('::jderobot::Encoders', Encoders, (), None, ())
    Encoders._ice_type = _M_jderobot._t_EncodersDisp
