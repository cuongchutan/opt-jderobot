...
if 'IRData' not in _M_jderobot.__dict__:
    _M_jderobot.IRData = Ice.createTempClass()
    class IRData(Ice.Value):
        def __init__(self, received=0, timeStamp=Ice._struct_marker):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_IRData)

        __repr__ = __str__

    _M_jderobot._t_IRData = IcePy.defineValue('::jderobot::IRData', IRData, -1, (), False, False, None, (
        ('received', (), IcePy._t_int, False, 0),
        ('timeStamp', (), _M_jderobot._t_Time, False, 0)
    ))
    IRData._ice_type = _M_jderobot._t_IRData

    _M_jderobot.IRData = IRData
    del IRData

_M_jderobot._t_IR = IcePy.defineValue('::jderobot::IR', Ice.Value, -1, (), False, True, None, ())

if 'IRPrx' not in _M_jderobot.__dict__:
    _M_jderobot.IRPrx = Ice.createTempClass()
    class IRPrx(Ice.ObjectPrx):

        def getIRData(self, context=None):
            return _M_jderobot.IR._op_getIRData.invoke(self, ((), context))

        def getIRDataAsync(self, context=None):
            return _M_jderobot.IR._op_getIRData.invokeAsync(self, ((), context))

        def begin_getIRData(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.IR._op_getIRData.begin(self, ((), _response, _ex, _sent, context))

        def end_getIRData(self, _r):
            return _M_jderobot.IR._op_getIRData.end(self, _r)

        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.IRPrx.ice_checkedCast(proxy, '::jderobot::IR', facetOrContext, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return _M_jderobot.IRPrx.ice_uncheckedCast(proxy, facet)

        @staticmethod
        def ice_staticId():
            return '::jderobot::IR'
    _M_jderobot._t_IRPrx = IcePy.defineProxy('::jderobot::IR', IRPrx)

    _M_jderobot.IRPrx = IRPrx
    del IRPrx

    _M_jderobot.IR = Ice.createTempClass()
    class IR(Ice.Object):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::jderobot::IR')
        ...
        def getIRData(self, current=None):
            raise NotImplementedError("servant method 'getIRData' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_IRDisp)

        __repr__ = __str__

    _M_jderobot._t_IRDisp = IcePy.defineClass('::jderobot::IR', IR, (), None, ())
    IR._ice_type = _M_jderobot._t_IRDisp

    IR._op_getIRData = IcePy.Operation('getIRData', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), _M_jderobot._t_IRData, False, 0), ())
