...
if 'rgbData' not in _M_jderobot.__dict__:
    _M_jderobot.rgbData = Ice.createTempClass()
    class rgbData(object):
        def __init__(self, color=None, depth=None, timeStamp=Ice._struct_marker):
            self.color = color
            self.depth = depth
            if timeStamp is Ice._struct_marker:
                self.timeStamp = _M_jderobot.Time()
        ...
        def __eq__(self, other):
            if other is None:
                return False
            elif not isinstance(other, _M_jderobot.rgbData):
                return NotImplemented
            else:
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_rgbData)

        __repr__ = __str__

    _M_jderobot._t_rgbData = IcePy.defineStruct('::jderobot::rgbData', rgbData, (), (
        ('color', (), _M_jderobot._t_ImageData),
        ('depth', (), _M_jderobot._t_ImageData),
        ('timeStamp', (), _M_jderobot._t_Time)
    ))

    _M_jderobot.rgbData = rgbData
    del rgbData

_M_jderobot._t_rgbd = IcePy.defineValue('::jderobot::rgbd', Ice.Value, -1, (), False, True, None, ())

if 'rgbdPrx' not in _M_jderobot.__dict__:
    _M_jderobot.rgbdPrx = Ice.createTempClass()
    class rgbdPrx(Ice.ObjectPrx):

        def getData(self, context=None):
            return _M_jderobot.rgbd._op_getData.invoke(self, ((), context))

        def getDataAsync(self, context=None):
            return _M_jderobot.rgbd._op_getData.invokeAsync(self, ((), context))

        def begin_getData(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.rgbd._op_getData.begin(self, ((), _response, _ex, _sent, context))

        def end_getData(self, _r):
            return _M_jderobot.rgbd._op_getData.end(self, _r)

        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.rgbdPrx.ice_checkedCast(proxy, '::jderobot::rgbd', facetOrContext, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return _M_jderobot.rgbdPrx.ice_uncheckedCast(proxy, facet)

        @staticmethod
        def ice_staticId():
            return '::jderobot::rgbd'
    _M_jderobot._t_rgbdPrx = IcePy.defineProxy('::jderobot::rgbd', rgbdPrx)

    _M_jderobot.rgbdPrx = rgbdPrx
    del rgbdPrx

    _M_jderobot.rgbd = Ice.createTempClass()
    class rgbd(Ice.Object):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::jderobot::rgbd')
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_rgbdDisp)

        __repr__ = __str__

    _M_jderobot._t_rgbdDisp = IcePy.defineClass('::jderobot::rgbd', rgbd, (), None, ())
    rgbd._ice_type = _M_jderobot._t_rgbdDisp

    rgbd._op_getData = IcePy.Operation('getData', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), _M_jderobot._t_rgbData, False, 0), ())

    _M_jderobot.rgbd = rgbd
    del rgbd
