...
if 'LaserData' not in _M_jderobot.__dict__:
    ...
    _M_jderobot._t_LaserData = IcePy.defineValue('::jderobot::LaserData', LaserData, -1, (), False, False, None, (
...
_M_jderobot._t_Laser = IcePy.defineValue('::jderobot::Laser', Ice.Value, -1, (), False, True, None, ())

if 'LaserPrx' not in _M_jderobot.__dict__:
    _M_jderobot.LaserPrx = Ice.createTempClass()
    class LaserPrx(Ice.ObjectPrx):

        def getLaserData(self, context=None):
            return _M_jderobot.Laser._op_getLaserData.invoke(self, ((), context))

        def getLaserDataAsync(self, context=None):
            return _M_jderobot.Laser._op_getLaserData.invokeAsync(self, ((), context))

        def begin_getLaserData(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.Laser._op_getLaserData.begin(self, ((), _response, _ex, _sent, context))
        ...
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.LaserPrx.ice_checkedCast(proxy, '::jderobot::Laser', facetOrContext, context)
    ...
    class Laser(Ice.Object):
        ...
        def getLaserData(self, current=None):
            raise NotImplementedError("servant method 'getLaserData' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_LaserDisp)

        __repr__ = __str__

    _M_jderobot._t_LaserDisp = IcePy.defineClass('::jderobot::Laser', Laser, (), None, ())
    Laser._ice_type = _M_jderobot._t_LaserDisp
