...
if 'HardwareFailedException' not in _M_RoboCompJointMotor.__dict__:
    ...
    class HardwareFailedException(Ice.UserException):
        ...
        _ice_id = '::RoboCompJointMotor::HardwareFailedException'
...
if 'OutOfRangeException' not in _M_RoboCompJointMotor.__dict__:
    ...
    class OutOfRangeException(Ice.UserException):
        ...
        _ice_id = '::RoboCompJointMotor::OutOfRangeException'
...
if 'UnknownMotorException' not in _M_RoboCompJointMotor.__dict__:
    ...
    class UnknownMotorException(Ice.UserException):
        ...
        _ice_id = '::RoboCompJointMotor::UnknownMotorException'
...
_M_RoboCompJointMotor._t_JointMotor = IcePy.defineValue('::RoboCompJointMotor::JointMotor', Ice.Value, -1, (), False, True, None, ())

if 'JointMotorPrx' not in _M_RoboCompJointMotor.__dict__:
    _M_RoboCompJointMotor.JointMotorPrx = Ice.createTempClass()
    class JointMotorPrx(Ice.ObjectPrx):

        def setPosition(self, goal, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_setPosition.invoke(self, ((goal, ), context))

        def setPositionAsync(self, goal, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_setPosition.invokeAsync(self, ((goal, ), context))

        def begin_setPosition(self, goal, _response=None, _ex=None, _sent=None, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_setPosition.begin(self, ((goal, ), _response, _ex, _sent, context))

        def end_setPosition(self, _r):
            return _M_RoboCompJointMotor.JointMotor._op_setPosition.end(self, _r)

        def setVelocity(self, goal, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_setVelocity.invoke(self, ((goal, ), context))

        def setVelocityAsync(self, goal, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_setVelocity.invokeAsync(self, ((goal, ), context))

        def begin_setVelocity(self, goal, _response=None, _ex=None, _sent=None, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_setVelocity.begin(self, ((goal, ), _response, _ex, _sent, context))

        def end_setVelocity(self, _r):
            return _M_RoboCompJointMotor.JointMotor._op_setVelocity.end(self, _r)

        def setSyncPosition(self, listGoals, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_setSyncPosition.invoke(self, ((listGoals, ), context))

        def setSyncPositionAsync(self, listGoals, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_setSyncPosition.invokeAsync(self, ((listGoals, ), context))

        def begin_setSyncPosition(self, listGoals, _response=None, _ex=None, _sent=None, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_setSyncPosition.begin(self, ((listGoals, ), _response, _ex, _sent, context))

        def end_setSyncPosition(self, _r):
            return _M_RoboCompJointMotor.JointMotor._op_setSyncPosition.end(self, _r)

        def getMotorParams(self, motor, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorParams.invoke(self, ((motor, ), context))

        def getMotorParamsAsync(self, motor, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorParams.invokeAsync(self, ((motor, ), context))

        def begin_getMotorParams(self, motor, _response=None, _ex=None, _sent=None, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorParams.begin(self, ((motor, ), _response, _ex, _sent, context))

        def end_getMotorParams(self, _r):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorParams.end(self, _r)

        def getMotorState(self, motor, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorState.invoke(self, ((motor, ), context))

        def getMotorStateAsync(self, motor, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorState.invokeAsync(self, ((motor, ), context))

        def begin_getMotorState(self, motor, _response=None, _ex=None, _sent=None, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorState.begin(self, ((motor, ), _response, _ex, _sent, context))

        def end_getMotorState(self, _r):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorState.end(self, _r)

        def getMotorStateMap(self, mList, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorStateMap.invoke(self, ((mList, ), context))

        def getMotorStateMapAsync(self, mList, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorStateMap.invokeAsync(self, ((mList, ), context))

        def begin_getMotorStateMap(self, mList, _response=None, _ex=None, _sent=None, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorStateMap.begin(self, ((mList, ), _response, _ex, _sent, context))

        def end_getMotorStateMap(self, _r):
            return _M_RoboCompJointMotor.JointMotor._op_getMotorStateMap.end(self, _r)

        def getAllMotorState(self, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getAllMotorState.invoke(self, ((), context))

        def getAllMotorStateAsync(self, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getAllMotorState.invokeAsync(self, ((), context))

        def begin_getAllMotorState(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getAllMotorState.begin(self, ((), _response, _ex, _sent, context))

        def end_getAllMotorState(self, _r):
            return _M_RoboCompJointMotor.JointMotor._op_getAllMotorState.end(self, _r)

        def getAllMotorParams(self, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getAllMotorParams.invoke(self, ((), context))

        def getAllMotorParamsAsync(self, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getAllMotorParams.invokeAsync(self, ((), context))

        def begin_getAllMotorParams(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getAllMotorParams.begin(self, ((), _response, _ex, _sent, context))

        def end_getAllMotorParams(self, _r):
            return _M_RoboCompJointMotor.JointMotor._op_getAllMotorParams.end(self, _r)

        def getBusParams(self, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getBusParams.invoke(self, ((), context))

        def getBusParamsAsync(self, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getBusParams.invokeAsync(self, ((), context))

        def begin_getBusParams(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_RoboCompJointMotor.JointMotor._op_getBusParams.begin(self, ((), _response, _ex, _sent, context))
        ...
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_RoboCompJointMotor.JointMotorPrx.ice_checkedCast(proxy, '::RoboCompJointMotor::JointMotor', facetOrContext, context)
    ...
    class JointMotor(Ice.Object):
        ...
        def setVelocity(self, goal, current=None):
            raise NotImplementedError("servant method 'setVelocity' not implemented")

        def setSyncPosition(self, listGoals, current=None):
            raise NotImplementedError("servant method 'setSyncPosition' not implemented")

        def getMotorParams(self, motor, current=None):
            raise NotImplementedError("servant method 'getMotorParams' not implemented")

        def getMotorState(self, motor, current=None):
            raise NotImplementedError("servant method 'getMotorState' not implemented")

        def getMotorStateMap(self, mList, current=None):
            raise NotImplementedError("servant method 'getMotorStateMap' not implemented")

        def getAllMotorState(self, current=None):
            raise NotImplementedError("servant method 'getAllMotorState' not implemented")

        def getAllMotorParams(self, current=None):
            raise NotImplementedError("servant method 'getAllMotorParams' not implemented")

        def getBusParams(self, current=None):
            raise NotImplementedError("servant method 'getBusParams' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_RoboCompJointMotor._t_JointMotorDisp)

        __repr__ = __str__

    _M_RoboCompJointMotor._t_JointMotorDisp = IcePy.defineClass('::RoboCompJointMotor::JointMotor', JointMotor, (), None, ())
    JointMotor._ice_type = _M_RoboCompJointMotor._t_JointMotorDisp
