...
if 'PTEncodersData' not in _M_jderobot.__dict__:
    ...
    class PTEncodersData(Ice.Value):
        """
    ...
    _M_jderobot._t_PTEncodersData = IcePy.defineValue('::jderobot::PTEncodersData', PTEncodersData, -1, (), False, False, None, (
...
_M_jderobot._t_PTEncoders = IcePy.defineValue('::jderobot::PTEncoders', Ice.Value, -1, (), False, True, None, ())

if 'PTEncodersPrx' not in _M_jderobot.__dict__:
    _M_jderobot.PTEncodersPrx = Ice.createTempClass()
    class PTEncodersPrx(Ice.ObjectPrx):

        def getPTEncodersData(self, context=None):
            return _M_jderobot.PTEncoders._op_getPTEncodersData.invoke(self, ((), context))

        def getPTEncodersDataAsync(self, context=None):
            return _M_jderobot.PTEncoders._op_getPTEncodersData.invokeAsync(self, ((), context))

        def begin_getPTEncodersData(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.PTEncoders._op_getPTEncodersData.begin(self, ((), _response, _ex, _sent, context))
        ...
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.PTEncodersPrx.ice_checkedCast(proxy, '::jderobot::PTEncoders', facetOrContext, context)
    ...
    class PTEncoders(Ice.Object):
        ...
        def getPTEncodersData(self, current=None):
            raise NotImplementedError("servant method 'getPTEncodersData' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_PTEncodersDisp)

        __repr__ = __str__

    _M_jderobot._t_PTEncodersDisp = IcePy.defineClass('::jderobot::PTEncoders', PTEncoders, (), None, ())
    PTEncoders._ice_type = _M_jderobot._t_PTEncodersDisp
