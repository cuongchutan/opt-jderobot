...
if 'BumperData' not in _M_jderobot.__dict__:
    _M_jderobot.BumperData = Ice.createTempClass()
    class BumperData(Ice.Value):
        def __init__(self, bumper=0, state=0, timeStamp=Ice._struct_marker):
            self.bumper = bumper
            self.state = state
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_BumperData)

        __repr__ = __str__

    _M_jderobot._t_BumperData = IcePy.defineValue('::jderobot::BumperData', BumperData, -1, (), False, False, None, (
        ('bumper', (), IcePy._t_int, False, 0),
        ('state', (), IcePy._t_int, False, 0),
        ('timeStamp', (), _M_jderobot._t_Time, False, 0)
    ))
    BumperData._ice_type = _M_jderobot._t_BumperData

    _M_jderobot.BumperData = BumperData
    del BumperData

_M_jderobot._t_Bumper = IcePy.defineValue('::jderobot::Bumper', Ice.Value, -1, (), False, True, None, ())

if 'BumperPrx' not in _M_jderobot.__dict__:
    _M_jderobot.BumperPrx = Ice.createTempClass()
    class BumperPrx(Ice.ObjectPrx):

        def getBumperData(self, context=None):
            return _M_jderobot.Bumper._op_getBumperData.invoke(self, ((), context))

        def getBumperDataAsync(self, context=None):
            return _M_jderobot.Bumper._op_getBumperData.invokeAsync(self, ((), context))

        def begin_getBumperData(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.Bumper._op_getBumperData.begin(self, ((), _response, _ex, _sent, context))

        def end_getBumperData(self, _r):
            return _M_jderobot.Bumper._op_getBumperData.end(self, _r)

        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.BumperPrx.ice_checkedCast(proxy, '::jderobot::Bumper', facetOrContext, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return _M_jderobot.BumperPrx.ice_uncheckedCast(proxy, facet)

        @staticmethod
        def ice_staticId():
            return '::jderobot::Bumper'
    _M_jderobot._t_BumperPrx = IcePy.defineProxy('::jderobot::Bumper', BumperPrx)

    _M_jderobot.BumperPrx = BumperPrx
    del BumperPrx

    _M_jderobot.Bumper = Ice.createTempClass()
    class Bumper(Ice.Object):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::jderobot::Bumper')
        ...
        def getBumperData(self, current=None):
            raise NotImplementedError("servant method 'getBumperData' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_BumperDisp)

        __repr__ = __str__

    _M_jderobot._t_BumperDisp = IcePy.defineClass('::jderobot::Bumper', Bumper, (), None, ())
    Bumper._ice_type = _M_jderobot._t_BumperDisp

    Bumper._op_getBumperData = IcePy.Operation('getBumperData', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), _M_jderobot._t_BumperData, False, 0), ())

    _M_jderobot.Bumper = Bumper
    del Bumper
