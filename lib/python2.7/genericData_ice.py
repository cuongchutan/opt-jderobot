...
if 'GenericData' not in _M_jderobot.__dict__:
    ...
    _M_jderobot._t_GenericData = IcePy.defineValue('::jderobot::GenericData', GenericData, -1, (), False, False, None, (
...
_M_jderobot._t_genericDataProvider = IcePy.defineValue('::jderobot::genericDataProvider', Ice.Value, -1, (), False, True, None, ())

if 'genericDataProviderPrx' not in _M_jderobot.__dict__:
    ...
    class genericDataProviderPrx(Ice.ObjectPrx):
        ...
        """
        def getGenericData(self, context=None):
            return _M_jderobot.genericDataProvider._op_getGenericData.invoke(self, ((), context))
        ...
        """
        def getGenericDataAsync(self, context=None):
            return _M_jderobot.genericDataProvider._op_getGenericData.invokeAsync(self, ((), context))
        ...
        """
        def begin_getGenericData(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.genericDataProvider._op_getGenericData.begin(self, ((), _response, _ex, _sent, context))
        ...
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.genericDataProviderPrx.ice_checkedCast(proxy, '::jderobot::genericDataProvider', facetOrContext, context)
    ...
    class genericDataProvider(Ice.Object):
        ...
        def getGenericData(self, current=None):
            ...
            Returns: A future object for the invocation.
            """
            raise NotImplementedError("servant method 'getGenericData' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_genericDataProviderDisp)

        __repr__ = __str__

    _M_jderobot._t_genericDataProviderDisp = IcePy.defineClass('::jderobot::genericDataProvider', genericDataProvider, (), None, ())
    genericDataProvider._ice_type = _M_jderobot._t_genericDataProviderDisp
