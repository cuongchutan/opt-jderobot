...
if 'Pose3DEncodersData' not in _M_jderobot.__dict__:
    ...
    class Pose3DEncodersData(Ice.Value):
        """
    ...
    _M_jderobot._t_Pose3DEncodersData = IcePy.defineValue('::jderobot::Pose3DEncodersData', Pose3DEncodersData, -1, (), False, False, None, (
...
_M_jderobot._t_Pose3DEncoders = IcePy.defineValue('::jderobot::Pose3DEncoders', Ice.Value, -1, (), False, True, None, ())

if 'Pose3DEncodersPrx' not in _M_jderobot.__dict__:
    _M_jderobot.Pose3DEncodersPrx = Ice.createTempClass()
    class Pose3DEncodersPrx(Ice.ObjectPrx):

        def getPose3DEncodersData(self, context=None):
            return _M_jderobot.Pose3DEncoders._op_getPose3DEncodersData.invoke(self, ((), context))

        def getPose3DEncodersDataAsync(self, context=None):
            return _M_jderobot.Pose3DEncoders._op_getPose3DEncodersData.invokeAsync(self, ((), context))

        def begin_getPose3DEncodersData(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_jderobot.Pose3DEncoders._op_getPose3DEncodersData.begin(self, ((), _response, _ex, _sent, context))
        ...
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_jderobot.Pose3DEncodersPrx.ice_checkedCast(proxy, '::jderobot::Pose3DEncoders', facetOrContext, context)
    ...
    class Pose3DEncoders(Ice.Object):
        ...
        def getPose3DEncodersData(self, current=None):
            raise NotImplementedError("servant method 'getPose3DEncodersData' not implemented")

        def __str__(self):
            return IcePy.stringify(self, _M_jderobot._t_Pose3DEncodersDisp)

        __repr__ = __str__

    _M_jderobot._t_Pose3DEncodersDisp = IcePy.defineClass('::jderobot::Pose3DEncoders', Pose3DEncoders, (), None, ())
    Pose3DEncoders._ice_type = _M_jderobot._t_Pose3DEncodersDisp
